...
<div style="margin:0;padding:24px;background:#f5f7fb;font-family:Arial,sans-serif;color:#1f2937;">
    <div style="max-width:620px;margin:0 auto;background:#ffffff;border-radius:16px;overflow:hidden;border:1px solid #e5e7eb;">
        <div style="background:{{ $primary }};padding:20px 24px;color:#ffffff;">
            ...
            <h1 style="margin:8px 0 0;font-size:22px;line-height:1.2;">Demande de réservation reçue</h1>
        </div>
        <div style="padding:24px;">
            <p style="margin:0 0 14px;">Bonjour {{ $reservation->customer_name }},</p>
            <p style="margin:0 0 16px;color:#4b5563;">Votre demande est bien enregistrée. L'équipe du restaurant revient vers vous rapidement avec une confirmation.</p>
            ...
            <p style="margin:0;">Merci pour votre confiance,<br><strong>{{ $reservation->restaurant->name }}</strong></p>
        </div>
    </div>
</div>
